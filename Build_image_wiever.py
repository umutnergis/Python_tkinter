...
def go_right():
    ...
    if(number <5):
        ...
        Button(root,text=">>",activebackground="green",activeforeground= DISABLED,command = go_right)
def go_left():
    global number
    if(number >=0):
        print("Number "+str(number))
        ...
        Button(root,text="<<",activebackground="red",activeforeground= DISABLED,command = go_left)
...
photo_list = [my_Label2,my_Label4,my_Label5,my_Label6]
photo_list[0].grid(column=0,row=0)
